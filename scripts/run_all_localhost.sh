...
export HANZO_TOOLS_RUNNER_DENO_BINARY_PATH="${workspaceFolder}/hanzo-bin/hanzo-node/hanzo-tools-runner-resources/deno"
export HANZO_TOOLS_RUNNER_UV_BINARY_PATH="${workspaceFolder}/hanzo-bin/hanzo-node/hanzo-tools-runner-resources/uv"
