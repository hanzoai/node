...
# Option 1: Hanzo Engine server (default port 36900)
...
# Option 3: Ollama fallback (default port 11434)
...
# export DEFAULT_EMBEDDING_MODEL="qwen3-embedding-8b" # Best: 4096 dims, 32K context, #1 on MTEB
