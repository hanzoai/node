...
fn tool_duplicate_tests() {
    ...
    run_test_one_node_network(|env| {
        Box::pin(async move {
            ...
            let tool_key_name: String = "local:::__node1_test_sep_hanzo:::demo_tool".to_string();
            ...
            let tool_key_name_duplicate = {
                ...
                // "tool_router_key": String("local:::__node1_test_sep_hanzo:::demo_tool_20250331_163342"), "version":
                // String("1.0.0")}
                fork_result
                    .get("tool_router_key")
                    .unwrap()
