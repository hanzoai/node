...
//             hanzo_logging::init_default_tracing,
...
//         db::{db_cron_task::CronTask, HanzoDB},
//         llm_provider::job_manager::JobManager,
//         managers::IdentityManager,
//         vector_fs::vector_fs::VectorFS,
//     };
//     use hanzo_node::{
//         llm_provider::job_callback_manager::JobCallbackManager,
...
//     // Note: Cron job is currently not implemented. So uncomment this test when it is implemented
//     // #[tokio::test]
//     // async fn test_process_cron_job() {
//     //     setup();
//     //     let db = Arc::new(HanzoDB::new("db_tests/").unwrap());
...
//     //     let sheet_manager_result =
//     //         SheetManager::new(db_weak.clone(), node_profile_name.extract_node().clone(), None).await;
...
//     //             my_agent_offerings_manager.clone(),
//     //             ext_agent_offerings_manager.clone(),
//     //         )
//     //         .await,
//     //     ));
