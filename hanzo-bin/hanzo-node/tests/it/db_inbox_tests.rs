...
async fn test_insert_two_messages_and_check_order_and_parent() {
    ...
    let paginated_messages = hanzo_db
...
async fn test_insert_messages_with_simple_tree_structure_and_root() {
    ...
    let paginated_messages_inbox = hanzo_db
    ...
    let parent_hash_test_2 = hanzo_db
        .get_parent_message_hash(
            &inbox_name_value,
    ...
    let root_message_parent_hash = hanzo_db
        .get_parent_message_hash(
            &inbox_name_value,
...
async fn db_inbox() {
    ...
    let last_messages_all = hanzo_db.get_last_messages_from_all(10).unwrap();
    ...
    let all_messages_inbox = hanzo_db
    ...
    let last_unread_messages_inbox = hanzo_db
    ...
    let last_unread_messages_inbox_page2 = hanzo_db
