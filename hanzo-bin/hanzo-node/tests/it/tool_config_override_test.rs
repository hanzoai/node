...
use hanzo_node::tools::tool_implementation::native_tools::sql_processor::get_database_path_from_db_name_config;
...
use hanzo_tools_primitives::tools::tool_playground::{SqlQuery, SqlTable};
...
fn test_tool_execution_with_config_override() {
    ...
    let e = rt.block_on(async {
        ...
        let node1_handler = tokio::spawn(async move {
            hanzo_log(HanzoLogOption::Tests, HanzoLogLevel::Debug, "Starting Node 1");
        ...
        tools_config_override.insert(
            "local:::__official_hanzo:::memory_management".to_string(),
            config_values,
        );
        ...
        let agent_data = json!({
            ...
            "tools": ["local:::__official_hanzo:::memory_management:::1.0.0"],
            "debug_mode": true,
