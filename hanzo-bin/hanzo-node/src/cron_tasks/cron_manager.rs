...
use hanzo_message_primitives::{
    schemas::{
        crontab::{CronTask, CronTaskAction}, inbox_name::InboxNameError, hanzo_name::HanzoName, ws_types::WSUpdateHandler
    }, hanzo_message::hanzo_message_schemas::{AssociatedUI, JobMessage}, hanzo_utils::{
...
impl CronManager {
    ...
    pub async fn process_job_message_queued(
        ...
        let hanzo_profile = HanzoName::from_node_and_profile_names(node_profile_name.to_string(), profile)?;
        ...
        match cron_job.action {
            CronTaskAction::CreateJobWithConfigAndMessage {
                ...
                let job_id = job_manager
                    .lock()
                    .await
                    .process_job_creation(job_creation_info_clone, &hanzo_profile, &llm_provider)
                    .await?;
                ...
                // Use send_job_message_with_bearer instead of HanzoMessageBuilder
