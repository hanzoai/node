...
pub async fn try_to_execute_rust_tool(
    ...
    let result = match tool_router_key {
        ...
        s if s == "local:::__official_hanzo:::hanzo_llm_map_reduce_processor" => {
        ...
        s if s == "local:::__official_hanzo:::hanzo_agent_prompt_processor" => {
        ...
        s if s == "local:::__official_hanzo:::hanzo_typescript_unsafe_processor" => {
        ...
        s if s == "local:::__official_hanzo:::hanzo_tool_config_updater" => {
        ...
        s if s == "local:::__official_hanzo:::hanzo_llm_prompt_processor" => {
        ...
        s if s == "local:::__official_hanzo:::hanzo_process_embeddings" => {
