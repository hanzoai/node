...
use hanzo_message_primitives::schemas::llm_providers::serialized_llm_provider::{Grok, LLMProviderInterface};
                ...
                match data_resp {
                    ...
                    Err(e) => {
                        hanzo_log(
                            HanzoLogOption::JobExecution,
                            HanzoLogLevel::Error,
                            format!("Failed to parse Grok response: {:?}", e).as_str(),
                        );
