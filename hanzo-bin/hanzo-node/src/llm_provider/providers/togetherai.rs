...
use hanzo_message_primitives::schemas::llm_providers::serialized_llm_provider::{LLMProviderInterface, TogetherAI};
            ...
            if let Some(key) = api_key {
                ...
                match data_resp {
                    Ok(data) => {
                        ...
                        return Ok(LLMInferenceResponse::new(response_string, None, json!({}), vec![], Vec::new(), None));
                    }
                    Err(e) => {
                        hanzo_log(
                            HanzoLogOption::JobExecution,
