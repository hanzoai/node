...
use hanzo_messages::schemas::llm_providers::serialized_llm_provider::{LLMProviderInterface, OpenAILegacy};
...
pub async fn handle_streaming_response(
    ...
    let res = client
        ...
        .header(
            ...
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-job-id").and_then(|v| v.as_str()))
                .unwrap_or(""),
        )
        .header(
            "X-Hanzo-Version",
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-version"))
                .and_then(|v| v.as_str())
                .unwrap_or(""),
        )
        .header(
            ...
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-identity"))
                .and_then(|v| v.as_str())
                .unwrap_or(""),
        )
        .header(
            ...
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-signature"))
                .and_then(|v| v.as_str())
                .unwrap_or(""),
        )
        .header(
            ...
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-metadata"))
                .and_then(|v| v.as_str())
                .unwrap_or(""),
        )
        .header(
            ...
            headers
                .as_ref()
                .and_then(|h| h.get("x-hanzo-session-id"))
                .and_then(|v| v.as_str())
                .unwrap_or(""),
        )
        .json(&payload)
...
mod tests {
    ...
    async fn test_parse_openai_stream_chunk_smtp_function_call() {
        ...
        let tools = Some(vec![serde_json::json!({
            "name": "hanzo_tool_config_updater",
            "tool_router_key": "test_router"
        })]);
        let ws_manager: Option<Arc<Mutex<dyn WSUpdateHandler + Send>>> = None;
        let mut reasoning_content = String::new();
        ...
        assert_eq!(fc.name, "hanzo_tool_config_updater");
    ...
    async fn test_parse_openai_stream_chunk_invalid_function_parameters() {
        ...
        buffer.push_str(r#"{"error": {"message": "Invalid schema for function 'hanzo_typescript_unsafe_processor': ['code', 'package', 'parameters', 'code'] has non-unique elements.", "type": "invalid_request_error", "param": "functions[2].parameters", "code": "invalid_function_parameters"}}"#);
        buffer.push('\n');
        ...
        if let Err(LLMProviderError::APIError(error_message)) = result {
            assert_eq!(
                error_message,
                "invalid_function_parameters: Invalid schema for function 'hanzo_typescript_unsafe_processor': ['code', 'package', 'parameters', 'code'] has non-unique elements."
            );
        } else {
    ...
    async fn test_parse_openai_stream_chunk_stagehand_runner() {
        ...
        let chunks = vec![
            ...
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"://"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"han"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"zo"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":".a"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"i"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"\"},{\""}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"action"}},"logprobs":null,"finish_reason":null}]}"#,
            r#"data: {"id":"chatcmpl-Ax0G9tSO1igQQTzurNfZr1djkABpr","object":"chat.completion.chunk","created":1738625713,"model":"gpt-4o-mini-2024-07-18","service_tier":"default","system_fingerprint":"fp_72ed7ab54c","choices":[{"index":0,"delta":{"function_call":{"arguments":"\":\""}},"logprobs":null,"finish_reason":null}]}"#,
            ...
            "choices": [
                {
                    ...
                    "message": {
                        ...
                        "function_call": {
                            "name": "stagehand_runner",
                            "arguments": "{\"commands\":[{\"action\":\"goto\",\"payload\":\"https://hanzo.ai\"},{\"action\":\"extract\",\"payload\":\"titles and subtitles\"}]}"
                        },
                        "refusal": null
                    },
                    "logprobs": null,
