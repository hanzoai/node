...
mod tests {
    ...
    fn test_claude_prepare_messages() {
        ...
        let llm_messages = vec![
            ...
            LlmMessage {
                role: Some("user".to_string()),
                content: Some("tell me what's the response when using hanzo echo tool with: say hello".to_string()),
                name: None,
                function_call: None,
                functions: None,
                images: Some(vec![]),
            ...
            LlmMessage {
                ...
                name: Some("hanzo__echo".to_string()),
                function_call: None,
                functions: None,
                images: None,
                videos: None,
        ...
        assert_eq!(messages[0]["content"], "tell me what's the response when using hanzo echo tool with: say hello");
        ...
        assert_eq!(assistant_content[0]["name"], "hanzo__echo");
            ...
            SubPrompt::ToolAvailable(
                ...
                serde_json::json!({
                    "function": {
                        ...
                        "tool_router_key": "local:::google_search_hanzo:::google_search"
                    },
                    "type": "function"
                }),
                98,
            ...
            SubPrompt::ToolAvailable(
                ...
                serde_json::json!({
                    "function": {
                        ...
                        "tool_router_key": "local:::smart_search_hanzo:::smart_search_engine"
                    },
                    "type": "function"
                }),
                97,
