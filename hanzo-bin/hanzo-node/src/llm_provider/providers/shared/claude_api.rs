...
mod tests {
    ...
    fn test_claude_prepare_messages() {
        ...
        assert_eq!(
            messages[0]["content"],
            "tell me what's the response when using hanzo echo tool with: say hello"
        );
