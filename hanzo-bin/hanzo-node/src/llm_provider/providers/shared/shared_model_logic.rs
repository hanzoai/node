...
pub async fn save_image_file(
    ...
    session_id: &str,
    db: &SqliteManager,
) -> Result<HanzoPath, LLMProviderError> {
    ...
    let hanzo_path = HanzoFileManager::save_and_process_file_with_jobid(
        &job_id,
        filename.clone(),
        image_data,
        db,
...
pub async fn send_tool_ws_update_with_status(
    ...
    use hanzo_message_primitives::schemas::ws_types::{ToolMetadata, ToolStatus, ToolStatusType, WSMessageType, WidgetMetadata};
