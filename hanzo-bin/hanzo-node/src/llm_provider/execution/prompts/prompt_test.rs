...
mod tests {
    ...
    fn test_generate_llm_messages() {
        ...
        let tool = RustTool::new(
            ...
            ToolOutputArg::empty(),
            None,
            "local:::__official_hanzo:::concat_strings".to_string(),
        );
        let hanzo_tool = HanzoTool::Rust(tool, true);
        ...
        let sub_prompts = vec![
            ...
            SubPrompt::Content(SubPromptType::ExtraContext, "- FAQ Hanzo Overview What's Hanzo? (Summary)  (Source: Hanzo - Ask Me Anything.docx, Section: ) 2024-05-05T00:33:00".to_string(), 97),
            SubPrompt::Content(SubPromptType::ExtraContext, "- Hanzo is a comprehensive super app designed to enhance how users interact with AI. It allows users to run AI locally, facilitating direct conversations with documents and managing files converted into AI embeddings for advanced semantic searches across user data. This local execution ensures privacy and efficiency, putting control directly in the user's hands.  (Source: Hanzo - Ask Me Anything.docx, Section: 2) 2024-05-05T00:33:00".to_string(), 97),
            SubPrompt::Content(SubPromptType::User, "tell me more about Hanzo. Answer the question using this markdown and the extra context provided: \n # Answer \n here goes the answer\n".to_string(), 100),
            SubPrompt::ToolAvailable(SubPromptType::AvailableTool, hanzo_tool.json_function_call_format().expect("mh"), 98),
        ];
        ...
        let expected_messages = vec![
            ...
            LlmMessage {
                role: Some("user".to_string()),
                content: Some("tell me more about Hanzo. Answer the question using this markdown and the extra context provided: \n # Answer \n here goes the answer\n".to_string()),
                name: None,
                function_call: None,
                functions: None,
                images: None,
            ...
            LlmMessage {
                ...
                functions: Some(vec![FunctionDetails {
                    ...
                    tool_router_key: Some("local:::__official_hanzo:::concat_strings".to_string()),
            ...
            LlmMessage {
                role: Some("user".to_string()),
                content: Some("Here is a list of relevant new content provided for you to potentially use while answering:\n- FAQ Hanzo Overview What's Hanzo? (Summary)  (Source: Hanzo - Ask Me Anything.docx, Section: ) 2024-05-05T00:33:00\n- Hanzo is a comprehensive super app designed to enhance how users interact with AI. It allows users to run AI locally, facilitating direct conversations with documents and managing files converted into AI embeddings for advanced semantic searches across user data. This local execution ensures privacy and efficiency, putting control directly in the user's hands.  (Source: Hanzo - Ask Me Anything.docx, Section: 2) 2024-05-05T00:33:00".to_string()),
                name: None,
                function_call: None,
                functions: None,
                images: None,
    ...
    fn test_generate_llm_messages_with_function_call() {
        ...
        let sub_prompts = vec![
            ...
            SubPrompt::ToolAvailable(
                ...
                hanzo_tool.json_function_call_format().expect("mh"),
                98,
            ),
            SubPrompt::Content(
                SubPromptType::User,
