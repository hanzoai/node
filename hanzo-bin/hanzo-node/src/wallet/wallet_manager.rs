...
use hanzo_message_primitives::schemas::{
    coinbase_mpc_config::CoinbaseMPCWalletConfig, invoices::{Invoice, Payment, PaymentStatusEnum}, hanzo_name::HanzoName, hanzo_tool_offering::ToolPrice, wallet_complementary::{WalletRole, WalletSource}, wallet_mixed::{Asset, Balance, PublicAddress}, x402_types::Network
};
...
impl WalletManager {
    ...
    pub async fn pay_invoice(&self, invoice: Invoice, node_name: HanzoName) -> Result<Payment, WalletError> {
        ...
        // Extract the asset information from hanzo_offering
        let price = invoice
            .hanzo_offering
