...
use hanzo_message_primitives::schemas::{
    hanzo_name::HanzoName, wallet_mixed::{Address, AddressBalanceList, Asset, Balance, PublicAddress, Transaction}, x402_types::{Network, PaymentRequirements}
};
...
pub trait CommonActions {
    ...
    fn get_balance(&self, node_name: HanzoName) -> Pin<Box<dyn Future<Output = Result<f64, WalletError>> + Send>>;
