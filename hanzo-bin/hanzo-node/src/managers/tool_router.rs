...
impl ToolRouter {
    ...
    async fn import_tools_from_directory(
        ...
        let url = env::var("HANZO_TOOLS_DIRECTORY_URL")
            .unwrap_or_else(|_| format!("https://store-api.hanzo.com/store/defaults"));
