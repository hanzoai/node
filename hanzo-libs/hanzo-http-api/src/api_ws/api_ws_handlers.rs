...
//! and the implementation is low-level and very coupled to the Hanzo Node.
...
use hanzo_message_primitives::hanzo_utils::hanzo_logging::{
...
impl WebSocketProxy {
    ...
    /// Logs info message
    fn log_info(msg: &str) {
        hanzo_log(HanzoLogOption::WsAPI, HanzoLogLevel::Info, msg);
    }

    /// Logs error message
    fn log_error(msg: &str) {
        hanzo_log(HanzoLogOption::WsAPI, HanzoLogLevel::Error, msg);
    }
}
