...
#[openapi(
    ...
    components(
        schemas(AddFileToFolder, V2SmartInbox, APIChangeJobAgentRequest, CreateJobRequest, JobConfig,
            ...
            HanzoSubidentityType, OpenAI, LocalEngine, Groq, Gemini, Exo, HanzoBackend, SendResponseBody, SendResponseBodyData, APIError, GetToolingLogsRequest, GetMessageTracesRequest, ForkJobMessagesRequest, RemoveJobRequest)
    ),
    tags(
