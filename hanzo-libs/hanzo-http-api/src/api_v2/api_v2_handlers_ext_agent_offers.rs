...
use hanzo_message_primitives::schemas::{
    hanzo_tool_offering::{HanzoToolOffering, ToolPrice, UsageType}, wallet_mixed::{Asset, NetworkIdentifier}, x402_types::PaymentRequirements
};
...
pub struct SetToolOfferingRequest {
    pub tool_offering: HanzoToolOffering,
}
...
#[openapi(
    ...
    components(
        schemas(HanzoToolOffering, APIError, GetToolOfferingRequest, UsageType, ToolPrice, PaymentRequirements, Asset, NetworkIdentifier,
