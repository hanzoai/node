...
mod tests {
    ...
    fn test_decrypt_message_body_from_typescript_lib() {
        ...
        let encrypted_data = EncryptedHanzoBody {
    ...
    fn test_decrypt_message_data_from_typescript_lib() {
        ...
        let encrypted_data = EncryptedHanzoData {
            content: format!("encrypted:{}", encrypted_content),
        };
    ...
    //     let sender = "did:hanzo:localhost".to_string();
    //     let recipient = "did:hanzo:localhost".to_string();
