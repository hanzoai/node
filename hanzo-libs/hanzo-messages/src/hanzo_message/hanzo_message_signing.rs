    ...
    fn test_calculate_message_hash_with_empty_outer_signature() {
        ...
        let message = HanzoMessage {
            ...
            external_metadata: ExternalMetadata {
                sender: "did:hanzo:my_local_ai".to_string(),
                recipient: "did:hanzo:my_local_ai".to_string(),
        ...
        // Expected hash
        let expected_hash = "2072087e0a6e5c4df9d86162844cfb147cc430ac047764be721b27ec2960c73a";
