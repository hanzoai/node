...
use super::file_parser_helper::HanzoFileParser;
use super::text_group::TextGroup;

impl HanzoFileParser {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<Vec<TextGroup>, HanzoFsError>> + Send>> {
        Box::pin(async move {
                    ...
                    match result {
                        ...
                        Err(e) => {
                            ...
                            if max_batch_size > 5 {
                                ...
                                return Err(HanzoFsError::FailedEmbeddingGeneration(e.to_string()));
                            }
                        }
                    }
                }
