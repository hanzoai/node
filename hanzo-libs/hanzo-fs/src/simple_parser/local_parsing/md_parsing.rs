...
impl LocalFileParser {
    pub fn process_md_file(file_buffer: Vec<u8>, max_node_text_size: u64) -> Result<Vec<TextGroup>, HanzoFsError> {
        let md_string = String::from_utf8(file_buffer).map_err(|_| HanzoFsError::FailedMDParsing)?;
