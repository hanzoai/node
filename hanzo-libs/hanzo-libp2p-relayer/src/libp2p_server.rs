...
impl LibP2PProxy {
    pub async fn new(
        ...
        let registry = HanzoRegistry::new(&rpc_url, &contract_address, None)
            .await
        ...
        let encryption_secret_key = encryption_secret_key
            .or_else(|| {
                ...
                hanzo_message_primitives::hanzo_utils::encryption::string_to_encryption_static_key(&key).ok()
            })
        ...
        let node_name = HanzoName::new(node_name)
