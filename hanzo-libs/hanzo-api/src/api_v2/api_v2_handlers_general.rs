...
use hanzo_messages::schemas::llm_providers::serialized_llm_provider::{
    Exo, Gemini, Groq, LLMProviderInterface, LocalEngine, OpenAI, HanzoBackend,
};
...
use hanzo_messages::hanzo_message::hanzo_message::{
    EncryptedHanzoBody, EncryptedHanzoData, ExternalMetadata, InternalMetadata, MessageBody, MessageData,
    NodeApiData, HanzoBody, HanzoData, HanzoMessage, HanzoVersion,
};
...
use hanzo_messages::{
    ...
    hanzo_message::hanzo_message_schemas::APIAddOllamaModels,
};
...
#[openapi(
    ...
    components(
        schemas(APIAddOllamaModels, SerializedLLMProvider, HanzoName, LLMProviderInterface,
            ...
            OpenAI, LocalEngine, Groq, Gemini, Exo, EncryptedHanzoBody, HanzoBody,
