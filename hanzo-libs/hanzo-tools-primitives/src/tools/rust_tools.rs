...
use hanzo_message_primitives::hanzo_utils::utils;

use crate::tools::error::ToolError;

use super::parameters::Parameters;
use super::hanzo_tool::HanzoToolHeader;
...
impl RustTool {
    ...
    pub fn from_hanzo_tool_header(header: &HanzoToolHeader) -> Result<Self, ToolError> {
        Ok(RustTool {
