...
pub struct RelayManager {
    ...
    request_response_channels:
        DashMap<request_response::OutboundRequestId, request_response::ResponseChannel<HanzoMessage>>, // request_id -> channel
...
impl RelayManager {
    ...
    pub async fn new(
        ...
        let swarm_config = Config::with_executor(Box::new(|fut| {
            tokio::spawn(fut);
        }))
