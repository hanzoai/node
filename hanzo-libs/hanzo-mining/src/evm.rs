...
impl ChainConfig {
    ...
    pub fn lux_mainnet() -> Self {
        Self {
            ...
            rpc_url: "https://api.lux.network/v1/chain/c".to_string(),
    ...
    pub fn lux_testnet() -> Self {
        Self {
            ...
            rpc_url: "https://api.lux-test.network/v1/chain/c".to_string(),
...
impl TeleportDestination {
    ...
    pub fn rpc_url(&self) -> &str {
        match self {
            Self::LuxCChain => "https://api.lux.network/v1/chain/c",
