...
use super::{
    hanzo_name::HanzoName, hanzo_tool_offering::{HanzoToolOffering, UsageTypeInquiry}, tool_router_key::ToolRouterKey, wallet_mixed::PublicAddress
};
...
pub struct Invoice {
    ...
    pub provider_name: HanzoName,
    pub requester_name: HanzoName,
    pub usage_type_inquiry: UsageTypeInquiry,
    pub hanzo_offering: HanzoToolOffering,
