...
use super::{
    llm_message::{DetailedFunctionCall, LlmMessage}, hanzo_fs::HanzoFileChunkCollection, subprompts::{SubPrompt, SubPromptAssetContent, SubPromptAssetDetail, SubPromptAssetType, SubPromptType}
};
...
impl Prompt {
    ...
    pub fn add_ret_node_content(
        &mut self,
        retrieved_node: HanzoFileChunkCollection,
        prompt_type: SubPromptType,
        priority_value: u8,
    ) {
