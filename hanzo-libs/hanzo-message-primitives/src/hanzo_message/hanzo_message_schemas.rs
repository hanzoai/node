...
impl MessageSchemaType {
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            ...
            "SetHanzoTool" => Some(Self::SetHanzoTool),
            "ListAllHanzoTools" => Some(Self::ListAllHanzoTools),
            "GetHanzoTool" => Some(Self::GetHanzoTool),
            "SearchHanzoTool" => Some(Self::SearchHanzoTool),
    ...
    pub fn to_str(&self) -> &'static str {
        match self {
            ...
            Self::SetHanzoTool => "SetHanzoTool",
            Self::ListAllHanzoTools => "ListAllHanzoTools",
            Self::GetHanzoTool => "GetHanzoTool",
            Self::SearchHanzoTool => "SearchHanzoTool",
...
pub struct WSMessageResponse {
    pub subscriptions: Vec<TopicSubscription>,
    pub hanzo_message: HanzoMessage,
}
