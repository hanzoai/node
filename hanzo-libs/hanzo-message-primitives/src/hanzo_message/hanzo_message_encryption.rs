    ...
    pub fn encrypt_outer_layer(
        ...
        match &self.body {
            MessageBody::Encrypted(_) => {
                return Err(HanzoMessageError::AlreadyEncrypted(
...
impl MessageBody {
    ...
    pub fn decrypt(
        ...
        self_sk: &EncryptionStaticKey,
        sender_pk: &EncryptionPublicKey,
    ) -> Result<HanzoBody, HanzoMessageError> {
        match self {
    ...
    pub fn encrypt_message_body(
        ...
        Ok(MessageBody::Encrypted(EncryptedHanzoBody {
            content: encrypted_content,
        }))
    }

    pub fn decrypt_message_body(
        encrypted_body: &EncryptedHanzoBody,
        self_sk: &EncryptionStaticKey,
        sender_pk: &EncryptionPublicKey,
    ) -> Result<HanzoBody, HanzoMessageError> {
...
impl MessageData {
    ...
    pub fn decrypt(
        ...
        self_sk: &EncryptionStaticKey,
        sender_pk: &EncryptionPublicKey,
    ) -> Result<HanzoData, HanzoMessageError> {
        match self {
    ...
    pub fn decrypt_message_data(
        encrypted_data: &EncryptedHanzoData,
        self_sk: &EncryptionStaticKey,
        sender_pk: &EncryptionPublicKey,
    ) -> Result<HanzoData, HanzoMessageError> {
...
impl HanzoData {
    pub fn encrypt(
        ...
        self_sk: &EncryptionStaticKey,
        destination_pk: &EncryptionPublicKey,
    ) -> Result<EncryptedHanzoData, HanzoMessageError> {
