mod tests {
    ...
    fn test_encode_decode_message() {
        ...
        // Decode the message
        let decoded_message = HanzoMessage::decode_message_result(encoded_message).unwrap();
    ...
    fn test_serde_encode_decode_message() {
        ...
        // Deserialize the JSON string back to a HanzoMessage
        let deserialized_message: HanzoMessage = serde_json::from_str(&serialized_message).unwrap();
    ...
    fn test_serialize_deserialize_job_message_with_files() {
        // Create a sample JobMessage with a HanzoPath in files
        let job_message = JobMessage {
            job_id: "test_job_id".to_string(),
            ...
            metadata: None,
            tool_key: Some("tool_key".to_string()),
            fs_files_paths: vec![HanzoPath::new("/path/to/file")],
