...
mod tests {
    ...
    fn test_from_node_and_profile_names_valid() {
        ...
        let result = HanzoName::from_node_and_profile_names("bob.shinkai".to_string(), "profileBob".to_string());
    ...
    #[test]
    fn test_has_profile() {
        let hanzo_name = HanzoName::new("@@charlie.shinkai/profileCharlie".to_string()).unwrap();
        assert!(hanzo_name.has_profile());
    }

    #[test]
    fn test_has_device() {
        let hanzo_name = HanzoName::new("@@dave.shinkai/profileDave/device/myDevice".to_string()).unwrap();
        assert!(hanzo_name.has_device());
    }

    #[test]
    fn test_has_no_subidentities() {
        let hanzo_name = HanzoName::new("@@eve.shinkai".to_string()).unwrap();
    ...
    fn test_get_profile_name_string() {
        let hanzo_name = HanzoName::new("@@frank.shinkai/profileFrank".to_string()).unwrap();
        assert_eq!(hanzo_name.get_profile_name_string(), Some("profilefrank".to_string()));

        let hanzo_name = HanzoName::new("@@frank.shinkai/profile_1/device/device_1".to_string()).unwrap();
    ...
    fn test_extract_node() {
        let hanzo_name = HanzoName::new("@@henry.shinkai/profileHenry/device/myDevice".to_string()).unwrap();
    ...
    #[test]
    fn test_contains() {
        let alice = HanzoName::new("@@alice.shinkai".to_string()).unwrap();
        let alice_profile = HanzoName::new("@@alice.shinkai/profileName".to_string()).unwrap();
        let alice_agent = HanzoName::new("@@alice.shinkai/profileName/agent/myChatGPTAgent".to_string()).unwrap();
        let alice_device = HanzoName::new("@@alice.shinkai/profileName/device/myDevice".to_string()).unwrap();
    ...
    fn test_does_not_contain() {
        let alice = HanzoName::new("@@alice.shinkai".to_string()).unwrap();
        let bob = HanzoName::new("@@bob.shinkai".to_string()).unwrap();
        let alice_profile = HanzoName::new("@@alice.shinkai/profileName".to_string()).unwrap();
        let alice_agent = HanzoName::new("@@alice.shinkai/profileName/agent/bobsGPT".to_string()).unwrap();
        let bob_agent = HanzoName::new("@@bob.shinkai/profileName/agent/myChatGPTAgent".to_string()).unwrap();
    ...
    fn test_get_fullname_string_without_node_name() {
        let hanzo_name1 = HanzoName::new("@@alice.shinkai".to_string()).unwrap();
        assert_eq!(hanzo_name1.get_fullname_string_without_node_name(), None);

        let hanzo_name2 = HanzoName::new("@@alice.shinkai/profileName".to_string()).unwrap();
        assert_eq!(
            hanzo_name2.get_fullname_string_without_node_name(),
            Some("profilename".to_string())
        );

        let hanzo_name3 = HanzoName::new("@@alice.shinkai/profileName/agent/myChatGPTAgent".to_string()).unwrap();
        assert_eq!(
            hanzo_name3.get_fullname_string_without_node_name(),
            Some("profilename/agent/mychatgptagent".to_string())
        );

        let hanzo_name4 = HanzoName::new("@@alice.shinkai/profileName/device/myPhone".to_string()).unwrap();
        assert_eq!(
