...
impl SqliteManager {
    ...
    pub fn get_and_create_job_folder(&self, job_id: &str) -> Result<HanzoPath, SqliteManagerError> {
    ...
    pub fn get_job_folder_name(&self, job_id: &str) -> Result<HanzoPath, SqliteManagerError> {
