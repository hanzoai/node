...
//     fn get_nodes(&self, vector_resource_id: &str, profile: &HanzoName) -> Result<Vec<Node>, SqliteManagerError> {
//         let profile_name = profile
//             .get_profile_name_string()
//             .ok_or(SqliteManagerError::InvalidIdentityName(profile.to_string()))?;
...
//     fn get_vr_header(&self, vector_resource_id: &str, profile: &HanzoName) -> Result<VRHeader, SqliteManagerError> {
//         let profile_name = profile
//             .get_profile_name_string()
//             .ok_or(SqliteManagerError::InvalidIdentityName(profile.to_string()))?;
