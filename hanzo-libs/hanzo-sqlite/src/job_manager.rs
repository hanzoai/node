...
use hanzo_message_primitives::{
    ...
    }, hanzo_message::{hanzo_message::HanzoMessage, hanzo_message_schemas::AssociatedUI}, hanzo_utils::{job_scope::MinimalJobScope, hanzo_time::HanzoStringTime}
};
...
impl SqliteManager {
    pub fn create_new_job(
...

        {
            ...
            let current_time = HanzoStringTime::generate_time_now();
    ...
    pub fn get_step_history(
        ...
        job_id: &str,
        fetch_step_history: bool,
    ) -> Result<Option<Vec<HanzoMessage>>, SqliteManagerError> {
        ...
        let first_messages: Vec<HanzoMessage> = messages
            .into_iter()
...
mod tests {
    ...
    use hanzo_message_primitives::{
        schemas::identity::StandardIdentityType, hanzo_message::hanzo_message_schemas::{IdentityPermissions, JobMessage, MessageSchemaType}, hanzo_utils::{
            encryption::{unsafe_deterministic_encryption_keypair, EncryptionMethod}, hanzo_message_builder::HanzoMessageBuilder, signatures::unsafe_deterministic_signature_keypair
        }
    };
    ...
    async fn test_get_job_with_messages() {
        ...
        for i in 1..=3 {
            ...
            db.unsafe_insert_inbox_message(&hanzo_message, None, None)
                .await
                .unwrap();
