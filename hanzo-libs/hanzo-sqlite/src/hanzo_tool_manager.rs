...
impl SqliteManager {
    ...
    /// Updates a HanzoTool entry by generating a new embedding
...
mod tests {
    ...
    use hanzo_message_primitives::schemas::x402_types::PaymentRequirements;
    ...
    use hanzo_tools_primitives::tools::python_tools::PythonTool;
    use hanzo_tools_primitives::tools::tool_config::{BasicConfig, ToolConfig};
