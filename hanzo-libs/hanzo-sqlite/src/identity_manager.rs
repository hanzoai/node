...
impl SqliteManager {
    ...
    pub fn get_all_profiles(&self, my_node_identity: HanzoName) -> Result<Vec<StandardIdentity>, SqliteManagerError> {
        ...
        let rows = stmt.query_map([], |row| {
            ...
            let full_identity_name =
                HanzoName::from_node_and_profile_names(my_node_identity_name.clone(), profile_name.to_string())
                    .map_err(|e| {
    ...
    pub fn get_profile(&self, full_identity_name: HanzoName) -> Result<Option<StandardIdentity>, SqliteManagerError> {
    ...
    pub fn does_identity_exist(&self, profile: &HanzoName) -> Result<bool, SqliteManagerError> {
    ...
    pub fn get_profile_permission(&self, profile: HanzoName) -> Result<IdentityPermissions, SqliteManagerError> {
        let profile_name = profile
            .get_profile_name_string()
            .ok_or(SqliteManagerError::InvalidIdentityName(profile.to_string()))?;
    ...
    pub fn get_device_permission(&self, device: HanzoName) -> Result<IdentityPermissions, SqliteManagerError> {
    ...
    pub fn get_device(&self, full_identity_name: HanzoName) -> Result<DeviceIdentity, SqliteManagerError> {
    ...
    pub fn get_all_devices(&self, my_node_identity: HanzoName) -> Result<Vec<DeviceIdentity>, SqliteManagerError> {
        let conn = self.get_connection()?;
...
mod tests {
    ...
    fn test_insert_and_get_profile() {
        ...
        let profile = StandardIdentity {
            full_identity_name: HanzoName::new("@@node1.shinkai/main_profile_node1".to_string()).unwrap(),
            addr: None,
    ...
    fn test_get_all_profiles() {
        ...
        let profile2 = StandardIdentity {
            full_identity_name: HanzoName::new("@@node1.shinkai/main_profile_node2".to_string()).unwrap(),
            addr: None,
            node_encryption_public_key: node1_encryption_pk,
            node_signature_public_key: node1_identity_pk,
        ...
        let profiles = manager
            .get_all_profiles(HanzoName::new("@@node1.shinkai/main_profile_node1".to_string()).unwrap())
            .unwrap();
    ...
    fn test_remove_profile() {
        ...
        let full_identity_name = HanzoName::new("@@node1.shinkai/main_profile_node1".to_string()).unwrap();
    ...
    fn test_get_all_profiles_and_devices() {
        ...
        let identities = manager
            .get_all_profiles_and_devices(HanzoName::new("@@node1.shinkai/main_profile_node1".to_string()).unwrap())
            .unwrap();
