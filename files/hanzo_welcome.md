...
You can find pre-built tools in the Hanzo Store (https://store.hanzo.com) or even create your own using Python or Deno (TypeScript/JavaScript). You decide which tools an agent can use.
...
* **Documentation:** For more detailed guides, visit the [Hanzo Docs](https://docs.hanzo.com).
